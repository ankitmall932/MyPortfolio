...
function Home () {
    return (
        <div className='w-full lg:h-180 h-full flex lg:flex-row flex-col-reverse  gap-5 '>
            ...
            <div className='lg:w-1/2 w-full  h-full flex justify-center items-center'>
                <img src="/Ankit Mall.jpeg" alt="" className='object-cover sm:h-80 md:h-100 lg:h-120 xl:h-150 h-32 sm:w-80 md:w-100 lg:w-120 xl:w-150 w-32  rounded-full shadow-2xl' />
            </div>
        </div>
    );
}
